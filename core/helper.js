...
exports.CANVAS_ATTRIBUTE_NAME = exports.ASYNC_SCRIPT_ATTRIBUTE_NAME = void 0;
Object.defineProperty(exports, "COMMENT_HEADER", {
  enumerable: true,
  get: function () {
    return _constants.COMMENT_HEADER;
  }
});
exports.LAZY_SRC_ATTRIBUTE_NAME = exports.INVALID_ELEMENT_ATTRIBUTE_NAME = exports.INPUT_VALUE_ATTRIBUTE_NAME = exports.INPUT_CHECKED_ATTRIBUTE_NAME = exports.INFOBAR_TAGNAME = exports.IMAGE_ATTRIBUTE_NAME = exports.HIDDEN_FRAME_ATTRIBUTE_NAME = exports.HIDDEN_CONTENT_ATTRIBUTE_NAME = exports.EMPTY_RESOURCE = exports.COMMENT_HEADER_LEGACY = void 0;
Object.defineProperty(exports, "MESSAGE_PREFIX", {
  enumerable: true,
  get: function () {
    return _constants.MESSAGE_PREFIX;
  }
});
Object.defineProperty(exports, "NO_SCRIPT_PROPERTY_NAME", {
  enumerable: true,
  get: function () {
    return _constants.NO_SCRIPT_PROPERTY_NAME;
  }
});
exports.VIDEO_ATTRIBUTE_NAME = exports.STYLE_ATTRIBUTE_NAME = exports.STYLESHEET_ATTRIBUTE_NAME = exports.SINGLE_FILE_UI_ELEMENT_CLASS = exports.SHADOW_ROOT_ATTRIBUTE_NAME = exports.SELECTED_CONTENT_ATTRIBUTE_NAME = exports.REMOVED_CONTENT_ATTRIBUTE_NAME = exports.PRESERVED_SPACE_ELEMENT_ATTRIBUTE_NAME = exports.POSTER_ATTRIBUTE_NAME = exports.ON_BEFORE_CAPTURE_EVENT_NAME = exports.ON_AFTER_CAPTURE_EVENT_NAME = void 0;
Object.defineProperty(exports, "WAIT_FOR_USERSCRIPT_PROPERTY_NAME", {
  enumerable: true,
  get: function () {
    return _constants.WAIT_FOR_USERSCRIPT_PROPERTY_NAME;
  }
});
exports.WIN_ID_ATTRIBUTE_NAME = void 0;
...
exports.initUserScriptHandler = initUserScriptHandler;
exports.normalizeFontFamily = normalizeFontFamily;
exports.postProcessDoc = postProcessDoc;
exports.preProcessDoc = preProcessDoc;
exports.removeQuotes = removeQuotes;
exports.serialize = serialize;
var cssUnescape = _interopRequireWildcard(require("./../vendor/css-unescape.js"));
var hooksFrames = _interopRequireWildcard(require("./../processors/hooks/content/content-hooks-frames.js"));
var infobar = _interopRequireWildcard(require("./infobar.js"));
...
const ON_BEFORE_CAPTURE_EVENT_NAME = exports.ON_BEFORE_CAPTURE_EVENT_NAME = _constants.SINGLE_FILE_PREFIX + "on-before-capture";
const ON_AFTER_CAPTURE_EVENT_NAME = exports.ON_AFTER_CAPTURE_EVENT_NAME = _constants.SINGLE_FILE_PREFIX + "on-after-capture";
const GET_ADOPTED_STYLESHEETS_REQUEST_EVENT = _constants.SINGLE_FILE_PREFIX + "request-get-adopted-stylesheets";
const GET_ADOPTED_STYLESHEETS_RESPONSE_EVENT = _constants.SINGLE_FILE_PREFIX + "response-get-adopted-stylesheets";
const UNREGISTER_GET_ADOPTED_STYLESHEETS_REQUEST_EVENT = _constants.SINGLE_FILE_PREFIX + "unregister-request-get-adopted-stylesheets";
const ON_INIT_USERSCRIPT_EVENT = _constants.SINGLE_FILE_PREFIX + "user-script-init";
const REMOVED_CONTENT_ATTRIBUTE_NAME = exports.REMOVED_CONTENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "removed-content";
const HIDDEN_CONTENT_ATTRIBUTE_NAME = exports.HIDDEN_CONTENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "hidden-content";
const KEPT_CONTENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "kept-content";
const HIDDEN_FRAME_ATTRIBUTE_NAME = exports.HIDDEN_FRAME_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "hidden-frame";
const PRESERVED_SPACE_ELEMENT_ATTRIBUTE_NAME = exports.PRESERVED_SPACE_ELEMENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "preserved-space-element";
const SHADOW_ROOT_ATTRIBUTE_NAME = exports.SHADOW_ROOT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "shadow-root-element";
const WIN_ID_ATTRIBUTE_NAME = exports.WIN_ID_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "win-id";
const IMAGE_ATTRIBUTE_NAME = exports.IMAGE_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "image";
const POSTER_ATTRIBUTE_NAME = exports.POSTER_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "poster";
const VIDEO_ATTRIBUTE_NAME = exports.VIDEO_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "video";
const CANVAS_ATTRIBUTE_NAME = exports.CANVAS_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "canvas";
const STYLE_ATTRIBUTE_NAME = exports.STYLE_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "movable-style";
const INPUT_VALUE_ATTRIBUTE_NAME = exports.INPUT_VALUE_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "input-value";
const INPUT_CHECKED_ATTRIBUTE_NAME = exports.INPUT_CHECKED_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "input-checked";
const LAZY_SRC_ATTRIBUTE_NAME = exports.LAZY_SRC_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "lazy-loaded-src";
const STYLESHEET_ATTRIBUTE_NAME = exports.STYLESHEET_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "stylesheet";
const DISABLED_NOSCRIPT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "disabled-noscript";
const SELECTED_CONTENT_ATTRIBUTE_NAME = exports.SELECTED_CONTENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "selected-content";
const INVALID_ELEMENT_ATTRIBUTE_NAME = exports.INVALID_ELEMENT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "invalid-element";
const ASYNC_SCRIPT_ATTRIBUTE_NAME = exports.ASYNC_SCRIPT_ATTRIBUTE_NAME = "data-" + _constants.SINGLE_FILE_PREFIX + "async-script";
...
const COMMENT_HEADER_LEGACY = exports.COMMENT_HEADER_LEGACY = "Archive processed by SingleFile";
const SINGLE_FILE_UI_ELEMENT_CLASS = exports.SINGLE_FILE_UI_ELEMENT_CLASS = "single-file-ui-element";
const INFOBAR_TAGNAME = exports.INFOBAR_TAGNAME = infobar.INFOBAR_TAGNAME;
const EMPTY_RESOURCE = exports.EMPTY_RESOURCE = "data:,";
...
function initUserScriptHandler() {
  addEventListener(ON_INIT_USERSCRIPT_EVENT, ({
    detail
  }) => globalThis[_constants.WAIT_FOR_USERSCRIPT_PROPERTY_NAME] = async (eventPrefixName, options) => {
    ...
    try {
      detailUserScript = detail == "jsonDetail" ? JSON.stringify({
  ...
  new MutationObserver(initUserScriptHandler).observe(globalThis.document, {
    childList: true
  });
}
...
function getElementsInfo(win, doc, element, options, data = {
  usedFonts: new Map(),
  canvases: [],
  images: [],
  posters: [],
  ...
  shadowRoots: [],
  markedElements: []
}, adoptedStyleSheetsCache = new Map(), ascendantHidden) {
      ...
      if (shadowRoot && !element.classList.contains(SINGLE_FILE_UI_ELEMENT_CLASS) && element.tagName.toLowerCase() != INFOBAR_TAGNAME) {
        ...
        try {
          if (shadowRoot.adoptedStyleSheets) {
            if (shadowRoot.adoptedStyleSheets.length) {
              ...
              shadowRoot.dispatchEvent(new CustomEvent(GET_ADOPTED_STYLESHEETS_REQUEST_EVENT, {
                bubbles: true
              }));
        ...
        try {
          if (shadowRoot.adoptedStyleSheets && shadowRoot.adoptedStyleSheets.length === undefined) {
            shadowRoot.dispatchEvent(new CustomEvent(UNREGISTER_GET_ADOPTED_STYLESHEETS_REQUEST_EVENT, {
              bubbles: true
            }));
          }
        } catch (error) {
...
function getResourcesInfo(win, doc, element, options, data, elementHidden, computedStyle) {
  ...
  if (tagName == "IMG") {
    const imageData = {
      currentSrc: elementHidden ? EMPTY_RESOURCE : options.loadDeferredImages && element.getAttribute(LAZY_SRC_ATTRIBUTE_NAME) || element.currentSrc
    };
    ...
    if (computedStyle) {
      ...
      if ((!boxShadow || boxShadow == "none") && (!backgroundImage || backgroundImage == "none") && (imageData.size.pxWidth > 1 || imageData.size.pxHeight > 1)) {

...
async function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c10 = function (name, args, length) {
      return options.callFunction(name, args, length);
    },
    peg$c11 = "{",
    peg$c12 = peg$literalExpectation("{", false),
    peg$c13 = "}",
    peg$c14 = peg$literalExpectation("}", false),
    peg$c15 = function (name, length) {
      return options.getVariableValue(name, length);
    },
    peg$c16 = "[",
    peg$c17 = peg$literalExpectation("[", false),
    peg$c18 = "]",
    peg$c19 = peg$literalExpectation("]", false),
    peg$c20 = function (length, unit) {
      return {
        length,
        unit
      };
